                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full border border-gray-400 shadow-md shadow-gray-200 p-2 focus-visible:outline-fuchsia-400/50"
                                />
                            ...
                            <button
                                type="submit"
                                className='flex col-span-2 w-full items-center justify-center mx-auto font-medium border border-fuchsia-900 px-3 py-1.5 bg-fuchsia-800 text-white text-sm hover:bg-fuchsia-900 hover:shadow shadow-gray-400 hover:cursor-pointer transition-all duration-200 disabled:bg-gray-400 disabled:border-gray-600 disabled:cursor-not-allowed'
                                disabled={loading}
                            >
