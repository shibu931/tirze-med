              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                {hasMore && (
                  <div className="sm:col-span-2 flex justify-center py-5">
                    <button className="px-2 py-1.5 border-2 border-fuchsia-800 text-fuchsia-800 font-semibold uppercase hover:text-white hover:bg-fuchsia-800 text-sm hover:cursor-pointer" onClick={loadMoreReviews} disabled={loadingMore}>
