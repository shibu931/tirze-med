    ...
    >
      ...
      <div className="mb-4 flex space-x-2 sm:space-x-4">
        ...
        <div className="flex flex-col space-y-2">
          <label className={`flex items-center font-bold ${deliveryOption === 'courier' ? 'text-fuchsia-900' : 'text-gray-700'}`}>
            <input
              type="radio"
              value="courier"
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6'>
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 shadow-md shadow-gray-200 p-2 focus-visible:outline-fuchsia-400/50"
              required
            />
          </div>
          <div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInPostChange}
              placeholder={t('pmn')}
              className="w-full border border-gray-300 shadow-md shadow-gray-200 p-2 focus-visible:outline-fuchsia-400/50 text-gray-600"
              required
            />
          </div>
        </div>
      ...
      <button
        type="submit"
        className="w-full mt-6 bg-fuchsia-600 text-white p-2 rounded hover:bg-fuchsia-700 disabled:bg-gray-400 disabled:cursor-not-allowed"  
