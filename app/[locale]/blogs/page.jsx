...
const page = async () => {
  ...
  return (
    <>
      <section className='bg-fuchsia-100 pt-12 pb-12 flex items-center justify-center border-b border-fuchsia-200'>
        <h1 className='text-center text-4xl font-bold uppercase text-fuchsia-950 tracking-widest'>{t('blog')}</h1>
      </section>
