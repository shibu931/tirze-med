  ...
  return (
    <main>
        ...
        <div>
          ...
          <div className="flex items-start justify-between max-w-80 sm:max-w-[460px] mt-8">
            <div className='flex flex-col items-center justify-center'>
              <FaRegClock className="text-3xl text-fuchsia-950" />
              <p className='text-xs sm:text-[13px] mt-2 font-semibold text-fuchsia-950'>{p('usp.shipping')}</p>
              <p className='text-[10px] text-gray-700 sm:text-xs'>{p('usp.shipping_time')}</p>
            </div>
            <div className='flex flex-col items-center justify-center'>
              <FaThermometerHalf className="text-3xl text-fuchsia-950" />
              <p className='text-xs sm:text-[13px] mt-2 font-semibold text-fuchsia-950'>{p('usp.quality')}</p>
            </div>
            <div className='flex flex-col items-center justify-center'>
              <ImLab className="text-3xl text-fuchsia-950" />
              <p className='text-xs sm:text-[13px] mt-2 font-semibold text-fuchsia-950'>{p('usp.stand_lab')}</p>
            </div>
          </div>
          <div className='flex mt-4'><Link href="#reviews" className='hover:underline hover:text-fuchsia-800'>{t('reviews')}</Link>
          ...
          <AddToCartBtn product={simplifiedProduct} className='flex items-center font-medium border border-fuchsia-900 px-3 py-2 bg-fuchsia-800 text-white hover:bg-fuchsia-900 hover:shadow shadow-gray-400 hover:cursor-pointer transition-all duration-200'>
      ...
      <section className='my-12'>
        ...
        <p className='mt-2 text-fuchsia-900 uppercase font-semibold'>{p('product_warning.additional_info')}</p>
        ...
        <p className="text-fuchsia-900 mt-5 font-semibold text-sm">{p('legal_desc')}</p>

        <div className="grid grid-cols-3 mt-5 sm:mt-10 gap-4 lg:gap-8">
          <div className="flex flex-col items-center justify-center">
            <TbTruckReturn className='text-3xl sm:text-7xl text-fuchsia-950' />
            <p className="text-[0.60rem] sm:text-xs text-center uppercase mt-2 font-bold">{p('usp.return_usp')}</p>
          </div>
          <div className="flex flex-col items-center justify-center">
            <ImLab className='text-3xl sm:text-6xl text-fuchsia-950' />
            <p className="text-[0.60rem] sm:text-xs text-center uppercase mt-2 font-bold">{p('usp.lab_ql_usp')}</p>
          </div>
          <div className="flex flex-col items-center justify-center">
            <IoShieldCheckmarkSharp className='text-3xl sm:text-6xl text-fuchsia-950' />
